...
export const PROJECTS: ProjectItem[] = [
  ...
  imageUrl: 'src/assets/tidalSS.png', 
  ...
  technologies: [
    ...
    { name: 'scikit-learn', logoUrl: 'https://cdn.simpleicons.org/scikitlearn/F7931E' },
  ],
  }, 
  {
  ...
  imageUrl: 'src/assets/potionWatch.png', 
  ...
  imageUrl: 'src/assets/serverless.jpg', 
  codeUrl: 'https://github.com/Zafeer-R/terraform-todo-app', 
  // demoUrl: 'http://zafeerrangoonwala.com',
  technologies: [
    { name: 'AWS', logoUrl: 'https://cdn.simpleicons.org/amazonwebservices/FF9900' },
    ...
    { name: 'DynamoDB', logoUrl: 'https://cdn.simpleicons.org/amazondynamodb/4053D6' },
  ],
}
]
